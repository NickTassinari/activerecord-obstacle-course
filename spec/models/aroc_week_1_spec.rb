...
# You can comment out the Ruby example after your AR is working. 
  ...
  it '3. finds order id of largest order' do
    ...
    order_id = Order.order(:amount).select(:id).last.id 
    # ------------------------------------------------------------
  ...
  it '4. finds orders of multiple amounts' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    orders_of_500_and_700 = Order.where(amount: [500, 700]).to_a
    orders_of_700_and_1000 = Order.where(amount: [700, 1000]).to_a 
    # ------------------------------------------------------------
